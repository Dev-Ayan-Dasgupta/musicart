    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          SizedBox(
            width: screenWidth,
            height: (isSortFilter) ? screenHeight * 0.55 : screenHeight * 0.76,
            child: Padding(
                  ...
                  Expanded(
                    child: AnimationLimiter(
                      ...
                      child: GridView.count(
                        ...
                        children: List.generate(filteredDrums.length, (index) {
                                ...
                                child: InstrumentCard(
                                    ...
                                    onWishTap: () {
                                      if (wishList
                                        ...
                                        setState(() {
                                          wishList.remove(filteredDrums[index]);
                                          //count++;
                                        });
                                      } else {
                                        setState(() {
                                    ...
                                    onCartTap: () {
                                      if (cartList
                                        ...
                                        setState(() {
                                          cartList.remove(filteredDrums[index]);
                                          cartMap.remove(filteredDrums[index]);
                                        });
                                      }
                                    },
